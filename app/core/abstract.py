...
class AbstractItem(models.Model):
    ...
    img_banner = models.ImageField(upload_to="images/category/banners/", blank=True, null=True)
    img_icon = models.ImageField(upload_to="images/category/icons/", blank=True, null=True)
    delete = models.BooleanField(default=False)
