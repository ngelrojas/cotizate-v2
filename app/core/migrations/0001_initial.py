...
import core.profile
import core.profileAssociation
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.FileField(blank=True, null=True, upload_to=core.profile.user_directory_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.FileField(blank=True, null=True, upload_to=core.profileAssociation.user_directory_path)),
                ('cities', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.city')),
                ('countries', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.country')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.FileField(blank=True, null=True, upload_to=core.profileCompany.user_directory_path)),
                ('cities', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.city')),
                ('countries', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.country')),
                ('profiles', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.personalprofile')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagen_main', models.FileField(upload_to=core.campaing.user_directory_path)),
