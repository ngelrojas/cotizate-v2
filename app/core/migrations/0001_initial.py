# Generated by Django 3.2.6 on 2022-07-04 00:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField()),
                ('header', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.campaing')),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
        ...
        migrations.AddField(
            model_name='campaing',
            name='profile',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.personalprofile'),
        ),
        migrations.AddField(
            model_name='campaing',
            name='profile_ca',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.profilecompany'),
        ),
        migrations.AddField(
            model_name='campaing',
            name='user',
