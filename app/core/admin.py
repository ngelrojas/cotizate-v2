...
admin.site.register(models.Updating)
admin.site.register(models.Denounce)
admin.site.register(models.DenounceText)
admin.site.register(models.DenouncePublic)
